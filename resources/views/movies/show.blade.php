<x-dlayout>
    <x-bg-image :imageUrl="$movie->bgImage">
        ...
        <div class="pt-10 flex flex-col space-y-4">
            ...
            <a href="/movies/{{$movie->id}}/edit" class="bg-pink-600 text-white text-sm hover:text-black transition-all duartion-400 hover:px-18 w-auto mr-auto rounded-xl text-bold px-15 py-5 mt-3">Edit Movie</a>
        </div>
    </x-bg-image>
    <x-mother>
        <x-section>
